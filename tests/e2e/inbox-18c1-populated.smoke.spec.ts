...
const FIXTURE_COMMAND = ["scripts/inbox-18c1-fixture.mjs"];
...
function expectedUnreadBadge() {
  const state = JSON.parse(
    readFileSync("output/playwright/inbox-18c1-fixture.json", "utf8"),
...
test.describe("Inbox 18C.1 populated certification", () => {
