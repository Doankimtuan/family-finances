...
- Auth session: email password, Google/Apple OAuth start, identity linking, sign-out, delete-account
...
Commands: `SignInWithPassword`, `SignUpWithPassword`, `RequestPasswordReset`, `StartOAuthSignIn`, `LinkIdentity`, `SignOut`, `DeleteAccount`, `CreateHousehold`, `AcceptInvitation`, `InviteMember`, `RevokeInvitation`, `UpdateHouseholdPolicy`, `UpdateAssumptions`  
Queries: `GetAuthContext`, `GetSessionUser`, `GetHousehold`, `ListMembers`, `ListInvitations`
...
Authenticated user; admin for assumptions; partner-visible audit on material changes (REQ-013, REQ-020). Auth providers per REQ-002a; money actions still REQ-002 / BR-02 / BR-02a. Linking conflicts fail closed (BR-02b).
