...
- Blocking confirms (destructive money, ritual approve)
- Focus trap; Esc when safe
- Width constrained to viewport; no full-bleed desktop modals
- Preview body required for money/plan lock
