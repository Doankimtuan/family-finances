...
Inventory count: **45** canonical components.

Tiers: primitive · foundation · feedback · containers · navigation · financial · composite

See [NOT_USED.md](./NOT_USED.md) for Drawer/Breadcrumb decisions.
