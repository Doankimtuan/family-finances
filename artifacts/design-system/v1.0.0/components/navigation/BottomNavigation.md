---
document: Component: BottomNavigation
...
Do not invent variants outside this spec; do not bypass shared tokens

## Variants

default with optional Inbox badge
...
Labels exactly: Home · Money · Plan · Inbox · Together. Health is **not** a 6th tab. No sidebar variant.
