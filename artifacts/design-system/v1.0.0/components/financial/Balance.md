...
Real Ledger position only (BR-01)
...
Do not use for jars, goals, or planned amounts
...
**Real Ledger only.** Never use Balance for jar/intention amounts. Use Amount + “Planned”/“In jar” labels for intention.
