...
active, paused, archived (non-target)
...
Label amounts as intention/planned — never unlabeled “Balance”. Only Active jars are allocation targets (BR-03).
