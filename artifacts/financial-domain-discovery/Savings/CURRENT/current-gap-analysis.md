...
- The architecture classifies `savings` as a ledger-owned application module rather than a peer bounded context, and states that money truth remains ledger accounts and transactions. Evidence: `artifacts/architecture-definition/CURRENT/Module-Catalog.md:19`, `artifacts/architecture-definition/CURRENT/Module-Catalog.md:34`.
- The architecture forbids Savings from importing Inbox, Plan, or Health, and says Inbox/app orchestrate maturity and early-withdrawal decisions after typed acknowledgment. Evidence: `artifacts/architecture-definition/CURRENT/Module-Catalog.md:38`, `artifacts/architecture-definition/CURRENT/Module-Catalog.md:39`.
