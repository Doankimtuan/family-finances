...
| `ST-E02-001` | E02 | Splash and Welcome screens | P0 | **full_implement** | Not started |
| `ST-E02-002` | E02 | Login and session establishment | P0 | **full_implement** | Not started |
| `ST-E02-003` | E02 | Register and forgot password | P1 | **full_implement** | Not started |
...
| `AC-002` | `artifacts/product-definition/CURRENT/Official-Acceptance-Criteria.md` |
| `BR-02`, `BR-02a` | Auth + membership; RLS member invariant |
