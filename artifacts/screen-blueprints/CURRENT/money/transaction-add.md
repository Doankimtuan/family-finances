---
screen_id: money.transaction-add
title: Add Transaction
nav_group: money
feature_ids: ["F-Money"]
module: ledger
phase: MVP
route: /(product)/money/transactions/new
...
# Add Transaction (`money.transaction-add`)
...
money.hub; Home QuickAction; money.transactions

## Exit Points

money.hub; inbox.queue; money.transactions
...
`Amount`, `Input`, `Select`, `Button`, `Alert`, `Sheet`
...
REQ-005, REQ-006, REQ-018, REQ-016, REQ-019

## Referenced Acceptance Criteria

AC-005, AC-006, AC-018, AC-016, AC-019

## Referenced APIs

API-Accounts, API-Jars-Review
...
`screen_view:money.transaction-add` · `action:primary` on primary CTAs · no PII in payloads
