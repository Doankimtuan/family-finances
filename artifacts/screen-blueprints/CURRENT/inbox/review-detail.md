---
screen_id: inbox.review-detail
title: Review Item Detail
nav_group: inbox
feature_ids: ["F-Inbox"]
module: inbox
phase: MVP
route: /(product)/inbox/[id]
...
# Review Item Detail (`inbox.review-detail`)

## Purpose

One ReviewItem decision
...
`ReviewCard`, `Select`, `Button`, `Dialog`, `Alert`
...
`screen_view:inbox.review-detail` · `action:primary` on primary CTAs · no PII in payloads
