---
screen_id: together.invite-accept
title: Invite Accept
nav_group: together
...
# Invite Accept (`together.invite-accept`)
...
Invitee (Daily Partner / Household Steward per Product personas as applicable)
...
home.index; together.members; auth.login
...
`screen_view:together.invite-accept` · `action:primary` on primary CTAs · no PII in payloads
