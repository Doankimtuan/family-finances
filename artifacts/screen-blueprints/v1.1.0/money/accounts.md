---
screen_id: money.accounts
title: Accounts
nav_group: money
feature_ids: ["F-Money"]
module: ledger
phase: MVP
route: /(product)/money/accounts
...
money.account-detail; money.hub
...
`Card`, `Balance`, `EmptyState`, `TopAppBar`
...
`screen_view:money.accounts` · `action:primary` on primary CTAs · no PII in payloads
