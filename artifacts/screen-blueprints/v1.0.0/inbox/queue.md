...
Bottom nav; Home CTA; Deep links

## Exit Points

inbox.review-detail; home.index
...
`ReviewCard`, `Badge`, `EmptyState`, `BottomNavigation`, `Search`
...
REQ-005, REQ-010, REQ-020

## Referenced Acceptance Criteria

AC-005, AC-010, AC-020
...
`screen_view:inbox.queue` · `action:primary` on primary CTAs · no PII in payloads
