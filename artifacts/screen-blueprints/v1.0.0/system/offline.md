...
Connectivity required for mutations
...
Mutation while offline; Banner escalate
...
`screen_view:system.offline` · `action:primary` on primary CTAs · no PII in payloads
