...
**Official Implementation Constitution** — version `v1.1.0`.
...
5. **Coding Standards** (`artifacts/coding-standards/CURRENT`) is a companion pack that adds Staff-Engineer implementation *detail* (constants, magic strings, Tailwind class discipline, TypeScript/enum discipline, naming, folder, React smells, review gates) beneath this constitution. It tightens how code is written; it must never loosen this constitution's stack lock, folder/import graph, or Design System tokens. Where both speak to the same topic, this constitution's stack/architecture/design decisions win — Coding Standards wins on implementation-style detail this constitution leaves unspecified.
...
| [Coding Standards](../../coding-standards/CURRENT/README.md) | Constants, magic strings, Tailwind, TypeScript/enums, naming, folder, React smells, review checklist (companion pack) |
