...
| Coding Standards | No magic strings, duplicated literals/interfaces/utilities, unjustified arbitrary Tailwind, `any`, or deep relative imports — full gate: [Coding Standards / review-checklist.md](../../coding-standards/CURRENT/review-checklist.md) |
