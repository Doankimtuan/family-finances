...
| **Developer Constitution** | **UPDATED (v1.1)** | Updated canonical SoT references to `artifacts/specification-synchronization/CURRENT/` and PR checklists. | Enforces strict engineering governance. |
