...
4. **Developer Constitution v1.1**: Updates coding standards, magic-string policies, SoT directory paths (`artifacts/specification-synchronization/CURRENT/`), and PR review checklists.
