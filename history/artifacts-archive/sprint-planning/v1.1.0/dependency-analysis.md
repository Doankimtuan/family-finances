...
flowchart TD
  ...
  E02003 --> E02004[ST-E02-004 OAuth]
  E02004 --> E02005[ST-E02-005 linking]
  E02004 --> E02006[ST-E02-006 signout delete]
```

**Cycles:** none. Graph is a single chain with OAuth fan-out after register.
...
| Register/forgot working | OAuth-first Login + linking |
| OAuth working | Sign-out / delete |
