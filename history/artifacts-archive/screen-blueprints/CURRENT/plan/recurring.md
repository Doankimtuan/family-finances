---
screen_id: plan.recurring
title: Recurring
nav_group: plan
feature_ids: ["F-Plan"]
module: plan
phase: MVP
route: /(product)/plan/recurring
...
plan.hub; Weekly journey

## Exit Points

plan.recurring-detail; plan.hub
...
`screen_view:plan.recurring` · `action:primary` on primary CTAs · no PII in payloads
