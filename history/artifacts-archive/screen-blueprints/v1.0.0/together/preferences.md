---
screen_id: together.preferences
title: Preferences
nav_group: together
feature_ids: ["F-Together"]
module: tenancy
phase: MVP
route: /(product)/together/preferences
...
Profile, notifications, security, locale

## Primary Question

How should the app behave for me?

## Business Goal

Personal/household prefs
...
`screen_view:together.preferences` · `action:primary` on primary CTAs · no PII in payloads
