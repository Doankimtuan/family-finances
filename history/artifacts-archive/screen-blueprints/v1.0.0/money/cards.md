---
screen_id: money.cards
title: Cards / Installments
nav_group: money
feature_ids: ["F-Money"]
module: ledger
phase: MVP
route: /(product)/money/cards
...
# Cards / Installments (`money.cards`)

## Purpose

Cards and EMI overview
...
money.hub; inbox.queue; health.overview
...
Open installment detail via card
...
`screen_view:money.cards` · `action:primary` on primary CTAs · no PII in payloads
