---
screen_id: money.debt-detail
title: Debt Detail
nav_group: money
feature_ids: ["F-Money"]
module: ledger
phase: MVP
route: /(product)/money/debts/[id]
...
money.debts; money.transaction-add
...
`screen_view:money.debt-detail` · `action:primary` on primary CTAs · no PII in payloads
