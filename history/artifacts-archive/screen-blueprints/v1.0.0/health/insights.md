---
screen_id: health.insights
title: Insights
nav_group: health
feature_ids: ["F-Health"]
module: health
phase: MVP
route: /(product)/health/insights
...
`screen_view:health.insights` · `action:primary` on primary CTAs · no PII in payloads
