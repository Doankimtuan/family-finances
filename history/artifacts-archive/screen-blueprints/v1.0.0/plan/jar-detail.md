---
screen_id: plan.jar-detail
title: Jar Detail
nav_group: plan
feature_ids: ["F-Plan"]
module: plan
phase: MVP
route: /(product)/plan/jars/[id]
...
`screen_view:plan.jar-detail` · `action:primary` on primary CTAs · no PII in payloads
