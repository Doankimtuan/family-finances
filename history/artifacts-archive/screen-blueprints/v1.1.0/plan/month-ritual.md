---
screen_id: plan.month-ritual
title: Month Ritual
nav_group: plan
feature_ids: ["F-Plan"]
module: plan
phase: MVP
route: /(product)/plan/ritual
...
# Month Ritual (`plan.month-ritual`)

## Purpose

Preview → approve → lock

## Primary Question

Close this month intentionally?

## Business Goal

Assisted ritual (BR-08/09)

## Primary User

Household Steward (Daily Partner / Household Steward per Product personas as applicable)

## Entry Points

plan.hub; Deep link; Monthly journey
...
Cancel, Correction path if locked
...
`Dialog`, `Button`, `Alert`, `Progress`, `KPIBlock`
...
REQ-008, REQ-009, REQ-019, REQ-018

## Referenced Acceptance Criteria

AC-008, AC-009, AC-019, AC-018
...
`screen_view:plan.month-ritual` · `action:primary` on primary CTAs · no PII in payloads
