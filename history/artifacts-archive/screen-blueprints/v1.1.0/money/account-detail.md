---
screen_id: money.account-detail
title: Account Detail
nav_group: money
feature_ids: ["F-Money"]
module: ledger
phase: MVP
route: /(product)/money/accounts/[id]
...
# Account Detail (`money.account-detail`)
...
money.transactions; money.accounts
...
`Balance`, `TransactionRow`, `TopAppBar`
...
`screen_view:money.account-detail` · `action:primary` on primary CTAs · no PII in payloads
