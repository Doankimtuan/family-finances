---
screen_id: money.transaction-edit
title: Edit Transaction
nav_group: money
feature_ids: ["F-Money"]
module: ledger
phase: MVP
route: /(product)/money/transactions/[id]/edit
...
# Edit Transaction (`money.transaction-edit`)
...
`Amount`, `Input`, `Select`, `Button`, `Dialog`
...
`screen_view:money.transaction-edit` · `action:primary` on primary CTAs · no PII in payloads
