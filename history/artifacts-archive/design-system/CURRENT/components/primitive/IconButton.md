...
Icon-only actions with accessible name
...
Do not omit accessible name; do not use for primary money commit without label nearby

## Variants

ghost, subtle · sizes sm/md
