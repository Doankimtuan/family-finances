        ...
        <CardContent className="space-y-5 p-6">
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <SummaryCard
              ...
              helper={t(language, "jars.summary.rules_active", {
                count: String(data.summary.mappedExpenseRules),
              })}
            />
          </div>
        </CardContent>
        ...
        <section className="grid gap-4 xl:grid-cols-[1.35fr_0.95fr]">
                    ...
                    <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                      <div className="space-y-1">
                        ...
                        <p className="text-sm text-slate-500">
                          {t(language, "jars.item.current_balance")}{" "}
                          {formatVnd(jar.currentBalance, householdLocale)}.
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Button asChild variant="ghost" size="sm" className="rounded-xl">
                          <Link href={`/jars/setup?month=${month}#rules`}>
                            {t(language, "jars.item.edit_rules")}
                          </Link>
                        </Button>
                      </div>
                    </div>
                      ...
                      <div className="rounded-2xl bg-slate-50 p-4">
                        <div className="flex items-center justify-between text-sm">
                          <Label className="font-medium text-slate-600">
                            {t(language, "jars.item.monthly_inflow")}
                          </Label>
                        ...
                        <div className="mt-2 flex items-center justify-between text-sm">
                          <Label className="font-medium text-slate-600">
                            {t(language, "jars.item.monthly_outflow")}
                          </Label>
                          <span className="font-semibold text-slate-950">
          ...
          <div className="space-y-4">
            <Card className="border-border/60">
              ...
              <CardContent className="space-y-3">
                ...
                <Button asChild className="w-full rounded-xl">
                  <Link href="/jars/review">
                    {t(language, "jars.review.open_queue")}
                  </Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-border/60">
              <CardHeader className="pb-3">
                <CardTitle className="text-lg">
                  {t(language, "jars.manual_adjustment.title")}
                </CardTitle>
              </CardHeader>
              <CardContent>
