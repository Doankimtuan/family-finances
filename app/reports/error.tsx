  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-6">
      <section className="mx-auto w-full max-w-3xl rounded-2xl border border-rose-200 bg-white p-6 shadow-sm">
        <p className="text-sm font-semibold text-rose-700">Could not load reports.</p>
        <p className="mt-1 text-sm text-slate-600">Please retry. Your underlying finance data is unchanged.</p>
