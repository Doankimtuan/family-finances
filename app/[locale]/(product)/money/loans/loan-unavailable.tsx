...
/**
 * Recovery for a missing or unavailable loan surface. Copy and destination
 * stay with the caller so list vs detail vs schedule paths remain distinct.
 */
export function LoanUnavailable({
  title,
  description,
  actionHref,
  actionLabel,
  testId,
}: LoanUnavailableProps) {
  return (
    <EmptyState
      title={title}
      description={description}
      icon={<AppIcon icon={FINANCE_ICONS.loan} size={AppIconSize.DISPLAY} />}
