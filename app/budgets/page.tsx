        ...
        <Card className="border-primary/20 bg-primary/5">
          ...
          <CardContent>
            <p className="mb-3 rounded-lg border border-amber-300/60 bg-amber-50/60 px-3 py-2 text-xs text-amber-900">
              {language === "vi"
                ? "Màn hình Budget hiện là legacy. Vui lòng dùng màn hình giao dịch và mục tiêu để lập kế hoạch."
                : "Budget is now a legacy screen. Use transactions and goals for planning."}
            </p>
            <MonthlyBudgetForm
