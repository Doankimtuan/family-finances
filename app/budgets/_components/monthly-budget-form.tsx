  ...
  return (
    ...
    >
      <div className="space-y-1">
        <label htmlFor="budgetMonth" className="text-sm font-medium text-slate-700">Month</label>
        <input
          id="budgetMonth"
          name="month"
          type="month"
      ...
      <div className="space-y-1">
        <label htmlFor="budgetCategoryId" className="text-sm font-medium text-slate-700">Category</label>
        <select
          id="budgetCategoryId"
          name="categoryId"
          className="w-full rounded-xl border border-slate-300 bg-white px-3 py-3 text-base text-slate-900"
      ...
      <div className="space-y-1">
        <label htmlFor="plannedAmount" className="text-sm font-medium text-slate-700">Planned Amount (VND)</label>
        <VndQuickInput
          id="plannedAmount"
          name="plannedAmount"
          defaultValue={0}
