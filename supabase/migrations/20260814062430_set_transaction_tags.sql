-- Atomically replace the optional cross-cutting tags assigned to one transaction.
-- This command never mutates a financial ledger field or financial classification.
...
begin
  ...
  if v_tag_count <> (
    ...
    where household_id = v_household_id
      ...
      and id = any(v_normalized_tag_ids)
  ) then
