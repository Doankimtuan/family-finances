-- 12C: keep unit-price semantics for unit assets and allow the canonical
-- total-value exception for bond opening purchases.
create or replace function public.record_investment_initial_purchase(
  ...
  p_financial_scope text default 'household', p_total_value_vnd numeric default null
...
begin
  ...
  return public.record_investment_buy(
    holding_id,p_cash_account_id,p_quantity,p_unit_price_vnd,p_total_value_vnd,null,
