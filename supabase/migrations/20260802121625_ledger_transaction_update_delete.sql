-- ST-E04-003: Transaction update/delete RPCs + delete RLS (AC-006, AC-018)
...
begin
  ...
  -- If now mapped to a jar, resolve any pending inbox review for this txn
  if p_jar_id is not null then
