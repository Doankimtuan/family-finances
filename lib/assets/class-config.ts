...
export const ASSET_CLASS_CONFIGS: Record<AssetClassKey, AssetClassConfig> = {
  real_estate: {
    ...
    iconName: "Home",
    defaultUnitLabel: "assets.unit.property",
    defaultLiquid: false,
    defaultRisk: "medium",
  ...
  mutual_fund: {
    ...
    iconName: "TrendingUp",
    defaultUnitLabel: "assets.unit.ccq",
    defaultLiquid: true,
    defaultRisk: "medium",
  ...
  gold: {
    ...
    iconName: "Coins",
    defaultUnitLabel: "assets.unit.tael",
    defaultLiquid: true,
    defaultRisk: "low",
    defaultValuationMethod: "manual",
    isInvestmentTracker: true,
  ...
  crypto: {
    ...
    iconName: "Bitcoin",
    defaultUnitLabel: "assets.unit.coin",
    defaultLiquid: true,
  ...
  stock: {
    ...
    iconName: "TrendingUp",
    defaultUnitLabel: "assets.unit.share",
    defaultLiquid: true,
    defaultRisk: "high",
    defaultValuationMethod: "manual",
    isInvestmentTracker: true,
