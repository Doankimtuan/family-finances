...
- Name: auth-entry.smoke.spec.ts >> Splash + Welcome (ST-E02-001) >> Welcome exposes login and register CTAs
- Location: tests/e2e/auth-entry.smoke.spec.ts:17:7
...
- main:
    - heading "404" [level=1]
    - 'heading "Page not found: /en/welcome :(" [level=2]'
