...
- Name: system-shells.smoke.spec.ts >> System shells (ST-E08-001) >> error shell renders retry and home
- Location: tests/e2e/system-shells.smoke.spec.ts:4:7
...
Locator: getByTestId('system-error')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByTestId('system-error')
...
- main:
    - heading "404" [level=1]
    - 'heading "Page not found: /en/error :(" [level=2]'
