...
- Name: system-shells.smoke.spec.ts >> System shells (ST-E08-001) >> offline shell explains fail-closed mutations
- Location: tests/e2e/system-shells.smoke.spec.ts:13:7
...
Locator: getByTestId('system-offline')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByTestId('system-offline')
...
- main:
    - heading "404" [level=1]
    - 'heading "Page not found: /en/offline :(" [level=2]'
