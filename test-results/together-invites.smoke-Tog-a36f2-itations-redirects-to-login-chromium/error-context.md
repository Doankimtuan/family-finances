...
- Name: together-invites.smoke.spec.ts >> Together members + invitations (ST-E03-002 / F4) >> unauthenticated invitations redirects to login
- Location: tests/e2e/together-invites.smoke.spec.ts:7:7
...
Expected pattern: /\/en\/login/
Received string:  "http://localhost:3000/en/together/invitations"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × locator resolved to <html>…</html>
       - unexpected value "http://localhost:3000/en/together/invitations"
...
- main:
    - heading "404" [level=1]
    - 'heading "Page not found: /en/together/invitations :(" [level=2]'
