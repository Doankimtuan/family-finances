...
- Name: system-shells.smoke.spec.ts >> System shells (ST-E08-001) >> permission shell explains partner vs admin
- Location: tests/e2e/system-shells.smoke.spec.ts:25:7
...
Locator: getByTestId('system-permission')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByTestId('system-permission')
...
- main:
    - heading "404" [level=1]
    - 'heading "Page not found: /en/permission?reason=admin :(" [level=2]'
