...
| Surface                                              | Status                                                                                                                                                                                                                                                                                                                  |
| ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Money hub Investments row                            | Intentionally unchanged (already compliant)                                                                                                                                                                                                                                                                             |
| List summary + coverage                              | Redesigned — `Card tone="metric"` dominant value + quiet coverage notes; incomplete-basis stays the single warning alert                                                                                                                                                                                                |
| Allocation chart                                     | Redesigned (kept Recharts, token palette, quiet legend)                                                                                                                                                                                                                                                                 |
| Holdings scan + filters                              | Redesigned — shared `FilterChip` + `Input`; rows are `Card tone="interactive"` with value-first hierarchy; basis moved to detail; missing basis = warning badge                                                                                                                                                         |
| Closed section                                       | Redesigned — quiet `Card tone="soft"` rows + neutral Closed badge                                                                                                                                                                                                                                                       |
| List footer actions                                  | Redesigned — shared `Button` primary/secondary pair (Import / Convert)                                                                                                                                                                                                                                                  |
| Holding detail hero                                  | Redesigned — `Card tone="hero"` icon-chip pattern, ownership onHero, inline freshness; closed shows closed caption instead of value                                                                                                                                                                                     |
| Detail actions                                       | Redesigned — new `investment-detail-actions.tsx` (Buy primary, Sell secondary, overflow unchanged); Buy-on-closed and read-only rules preserved                                                                                                                                                                         |
| Performance / instrument sections                    | Redesigned layout, same labeled concepts (quantity, reference price/NAV, basis, unrealized, realized, income; gold note; provider line)                                                                                                                                                                                 |
| Activity history                                     | Redesigned — one divided list inside `Card tone="elevated"` (was one-card-per-event)                                                                                                                                                                                                                                    |
| Receipt / missing-basis / closed alerts              | Intentionally unchanged                                                                                                                                                                                                                                                                                                 |
| Not-found / read-error states                        | Intentionally unchanged (canonical already)                                                                                                                                                                                                                                                                             |
| Create wizard                                        | Redesigned chrome — shared `Progress` + "Step N of 3", `ChoiceTileGroup` entry-mode tiles; bond description copy fixed; 3-step/MotionStep/BottomActionBar contract preserved                                                                                                                                            |
| Instrument picker sheet                              | Intentionally unchanged (aligned already)                                                                                                                                                                                                                                                                               |
| Operation sheets (buy/sell/income/valuation/convert) | Redesigned chrome — native `LabeledSelect` → shared `SelectField`, native fee checkbox → `CheckboxField`, confirm footer → `SheetActionFooter`; sell adds deterministic "Remaining after sale" row (live preview + confirm summary); valuation sheet adds current-price context; **price-per-unit semantics untouched** |
| MAX / partial sell                                   | Preserved + verified (MAX fills exact quantity; remaining-units row)                                                                                                                                                                                                                                                    |
| Loading skeletons                                    | Redesigned to mirror new list/detail compositions                                                                                                                                                                                                                                                                       |
| i18n                                                 | `opening.stepOf`, `operation.remainingUnitsLabel` added (EN+VI); bond description corrected (EN+VI)                                                                                                                                                                                                                     |

Not redesigned (documented gaps, not reachable UI): Edit Investment and archive/close surfaces do not exist in the product; Convert remains minimal by design until the domain evolves.
Validation: typecheck ✓, eslint ✓, `next build` ✓, 34/34 investment unit tests ✓ (two pre-existing/brittle test expectations updated: date-pinned valuation fixture, SheetActionFooter pending-disabled Edit timing). English-only browser evidence at 390/440/768/1280 in light and dark, all states above exercised against the dev server.
