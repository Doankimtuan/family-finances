# `gaps/` — Product reverse-engineering (produce)
...
- Folder templates are human mirrors; runtime payloads use `entries[]` (see `schemas/product-re-payload.schema.json`).
