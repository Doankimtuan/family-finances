...
GENERATORS = [
    {"id": "schema-generator", "title": "Schema Generator",
     ...
     "partition_prefix": "framework-generator/generators/schema-generator/"},
    {"id": "artifact-generator", "title": "Artifact Generator",
     ...
     "partition_prefix": "framework-generator/generators/artifact-generator/"},
    {"id": "prompt-generator", "title": "Prompt Generator",
     ...
     "partition_prefix": "framework-generator/generators/prompt-generator/"},
    {"id": "worker-generator", "title": "Worker Generator",
     "mission": "Generate Worker package skeleton (README, skill, manifest, examples pointers) from capability specs. Does NOT generate validators, reviewers, tests, or docs — see overlap table in contracts/framework-generator.md.",
     ...
     "partition_prefix": "framework-generator/generators/worker-generator/"},
    {"id": "validator-generator", "title": "Validator Generator",
     ...
     "partition_prefix": "framework-generator/generators/validator-generator/"},
    {"id": "reviewer-generator", "title": "Reviewer Generator",
     ...
     "partition_prefix": "framework-generator/generators/reviewer-generator/"},
    {"id": "pipeline-generator", "title": "Pipeline Generator",
     ...
     "partition_prefix": "framework-generator/generators/pipeline-generator/"},
    {"id": "test-generator", "title": "Test Generator",
     ...
     "partition_prefix": "framework-generator/generators/test-generator/"},
    {"id": "documentation-generator", "title": "Documentation Generator",
     ...
     "partition_prefix": "framework-generator/generators/documentation-generator/"},
    {"id": "project-bootstrap-generator", "title": "Project Bootstrap Generator",
     ...
     "partition_prefix": "framework-generator/generators/project-bootstrap-generator/"},
]
...
ORCHESTRATOR = {
    ...
    "partition": "framework-generator/status/generation-orchestrator/",
...
REPORTER = {
    ...
    "partition": "framework-generator/reports/generation-reporter/",
...
5. `output_plan.artifacts` lists planned schema paths; `output_plan.registries` must include `schemas`.""",
    "artifact-generator": """1. Require upstream `schema-generator` plans or `schemas/` refs in evidence.
...
5. Do not embed worker business logic — framework prompts only.""",
    "worker-generator": """1. Copy plan from `templates/worker/` layout (README, skill.md, manifest.json, examples/, testcases/).
...
5. Registration patches owned by project-bootstrap-generator.""",
    "test-generator": """1. Bind to worker id from spec; load `templates/worker/testcases/` as baseline.
...
5. Never plan validator/reviewer specs.""",
    "project-bootstrap-generator": """1. Aggregate plans from all upstream generators (glob `framework-generator/generators/*/`).
...
5. Emit six entry_kinds minimum for full bootstrap spec.""",
    "generation-orchestrator": """1. Read `pipelines/framework-generator/pipeline.json` waves → emit plan + order entries.
...
def gen_skill_md(g: dict, is_orch: bool = False, is_rep: bool = False) -> str:
    ...
    part = g.get("partition_prefix") or g.get("partition", f"framework-generator/generators/{wid}/")
...
def gen_entry(g: dict, entry_kind: str, idx: int, extra: dict | None = None) -> dict:
    ...
    e = {
        ...
        "target": part,
        "spec_ref": f"configs/examples/{wid}.yaml",
        "output_plan": {
        ...
        "evidence": ["templates/worker/", "schemas/worker-manifest.schema.json"],
        ...
        "alternative_solution": "Manual copy from templates/",
        "confidence": 0.85,
        "source_paths": [f"configs/examples/{wid}.yaml", "templates/worker/"],
...
- `pipelines/framework-generator/RACI.md`
""")
    ...
    write(sdir / "manifest.json", json.dumps({
        ...
        "extensions": {"pipeline": PIPELINE, "mutate_source_artifacts": False, "execute_generation": False,
                       ...
                       "raci": f"pipelines/{PIPELINE}/RACI.md", "gate_output_type": "gate-framework-generation-report",
                       "entry_kinds": g["entry_kinds"]},
    }, indent=2) + "\n")
    write(wdir / "examples/sample-primary-payload.json", json.dumps(payload, indent=2) + "\n")
    write(wdir / "examples/sample-input.json", json.dumps({"spec": f"configs/examples/{wid}.yaml"}, indent=2) + "\n")
    ...
    write(wdir / "testcases/case-01-happy-path.json", json.dumps({
        ...
        "input": {"spec_ref": f"configs/examples/{wid}.yaml"},
    ...
    write(wdir / "testcases/case-03-invalid-schema-ref.json", json.dumps({
        ...
        "input": {"spec_ref": "configs/examples/invalid.yaml"},
...
def create_gates() -> None:
    ...
    write(ROOT / "reviewers" / "framework-generator-coverage-review" / "rubric" / "framework-generator-coverage.json", json.dumps({
        ...
        "criteria": [
            ...
            {"id": "template-reuse", "description": "Plans cite templates/ not duplicate content", "weight": 0.2, "scale_min": 0, "scale_max": 1},
            {"id": "registry-self-registration", "description": "output_plan.registries complete", "weight": 0.2, "scale_min": 0, "scale_max": 1},
            {"id": "semver-migration", "description": "semver + migration/deprecation when breaking", "weight": 0.2, "scale_min": 0, "scale_max": 1},
...
"""
    ...
    write(ROOT / "configs" / "README.md", "# Configs\n\nCapability specs for framework-generator. See `configs/examples/`.\n")
    for g in GENERATORS:
...
def update_registries() -> None:
    ...
    for meta in (ORCHESTRATOR, REPORTER):
        wid = meta["id"]
        workers["entries"][wid] = {
            "id": wid, "path": f"workers/{wid}", "version": PKG_VERSION, "status": "draft",
