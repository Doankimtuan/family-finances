...
**Scope:** `pipelines/framework-generator/` and related workers/skills/schemas/examples only
...
| M1–M7 | Typed `output_plan`, schema wrappers, shared capability template, `configs/examples/`, partition examples |
