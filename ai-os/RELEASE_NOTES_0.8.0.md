...
**Scope:** `pipelines/review-engine/` and related workers/skills/schemas/folders  
...
| I/O | Consume validation/reports/scores + knowledge/specifications; produce reviews/governance/recommendations/decisions/improvements |
