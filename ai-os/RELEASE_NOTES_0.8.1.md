...
**Scope:** `pipelines/review-engine/` and related workers/skills/schemas/examples only
...
| C5 | governance-decision folder_mirror partitions across decisions/recommendations/improvements/governance |
| H1 | Skill manifest descriptions restored |
| H2 | Gold critical/high/NO-GO samples; 9 reviewer fixtures in reviews/examples/ |
