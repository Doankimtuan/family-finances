...
- Consumes: `knowledge/`, `repository/`, `features/`, `business/`, `product-architecture/` (logical `architecture/`), `architecture-v2/`, `requirements/`, `quality/`, `redesign/`, `workflow/`, `acceptance/`
