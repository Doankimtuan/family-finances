# Skill Binding — `product-knowledge-ingest`

Skill claim/execute binding for Product RE worker `product-knowledge-ingest`.
Skills are declarative packages (`skills/product-knowledge-ingest`). Validators and reviewers are **not** skills.
...
| Worker allow-list | Optional: `product-knowledge-ingest` |
