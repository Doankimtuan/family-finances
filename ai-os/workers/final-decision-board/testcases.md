# Testcases — `final-decision-board`
...
Invariants: primary `governance-decision`; never mutate sources; never regenerate; never validate schemas; never invent missing info.
