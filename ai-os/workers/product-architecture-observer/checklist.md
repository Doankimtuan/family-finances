# Worker Conformance Checklist — `product-architecture-observer`
...
- [x] Directory name equals `product-architecture-observer`
...
- [x] Skill package reserved at `skills/product-architecture-observer/`
