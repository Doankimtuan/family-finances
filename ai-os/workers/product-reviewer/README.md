...
Review product vision, feature coverage, user journey, business alignment, requirement coverage, acceptance criteria, and missing product features.

## Identity

| Field | Value |
|-------|-------|
| Worker id | `product-reviewer` |
