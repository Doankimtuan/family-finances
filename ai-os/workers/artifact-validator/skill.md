# Skill Binding — `artifact-validator`

Skill claim/execute binding for Validation Engine worker `artifact-validator`.
Skills live under `skills/artifact-validator`.
