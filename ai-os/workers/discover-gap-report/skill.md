# Skill Binding — `discover-gap-report`

> Template for how this worker loads and executes AIOS **skills**.  
> Skills are declarative packages (`skills/discover-gap-report`). This worker is the runtime that claims runs and applies them.  
...
| Worker allow-list | Optional: `discover-gap-report` |
