# Skill Binding — `validation-reporter`

Skill claim/execute binding for Validation Engine worker `validation-reporter`.
Skills live under `skills/validation-reporter`.
