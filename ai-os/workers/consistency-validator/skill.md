# Skill Binding — `consistency-validator`

Skill claim/execute binding for Validation Engine worker `consistency-validator`.
Skills live under `skills/consistency-validator`.
