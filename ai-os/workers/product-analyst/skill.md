# Skill Binding — `product-analyst`

Skill claim/execute binding for Product RE worker `product-analyst`.
Skills are declarative packages (`skills/product-analyst`). Validators and reviewers are **not** skills.
...
| Worker allow-list | Optional: `product-analyst` |
