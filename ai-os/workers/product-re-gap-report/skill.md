# Skill Binding — `product-re-gap-report`

Skill claim/execute binding for Product RE worker `product-re-gap-report`.
Skills are declarative packages (`skills/product-re-gap-report`). Validators and reviewers are **not** skills.
...
| Worker allow-list | Optional: `product-re-gap-report` |
