# Worker Conformance Checklist — `business-rules-extractor`
...
- [x] Directory name equals `business-rules-extractor`
...
- [x] Skill package reserved at `skills/business-rules-extractor/`
...
- [x] Primary output `business-rules`
