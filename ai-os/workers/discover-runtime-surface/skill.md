# Skill Binding — `discover-runtime-surface`

> Template for how this worker loads and executes AIOS **skills**.  
> Skills are declarative packages (`skills/discover-runtime-surface`). This worker is the runtime that claims runs and applies them.  
...
| Worker allow-list | Optional: `discover-runtime-surface` |
