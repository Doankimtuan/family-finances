# Worker Conformance Checklist — `architecture-consultant`
...
- [x] Directory name equals `architecture-consultant`
...
- [x] Skill package reserved at `skills/architecture-consultant/`
