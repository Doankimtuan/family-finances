# Skill Binding — `architecture-consultant`

Skill claim/execute binding for Solution Architecture worker `architecture-consultant`.
Skills live under `skills/architecture-consultant`. Validators/reviewers are not skills.
...
| Worker allow-list | Optional: `architecture-consultant` |
