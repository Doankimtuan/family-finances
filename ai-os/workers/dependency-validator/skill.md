# Skill Binding — `dependency-validator`

Skill claim/execute binding for Validation Engine worker `dependency-validator`.
Skills live under `skills/dependency-validator`.
