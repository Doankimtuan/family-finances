# Skill Binding — `validation-orchestrator`

Skill claim/execute binding for Validation Engine worker `validation-orchestrator`.
Skills live under `skills/validation-orchestrator`.
