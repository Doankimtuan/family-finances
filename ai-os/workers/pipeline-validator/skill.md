# Skill Binding — `pipeline-validator`

Skill claim/execute binding for Validation Engine worker `pipeline-validator`.
Skills live under `skills/pipeline-validator`.
