# Skill Binding — `quality-scoring-engine`

Skill claim/execute binding for Validation Engine worker `quality-scoring-engine`.
Skills live under `skills/quality-scoring-engine`.
