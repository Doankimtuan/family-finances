# Skill Binding — `acceptance-criteria-generator`

Skill claim/execute binding for Product RE worker `acceptance-criteria-generator`.
Skills are declarative packages (`skills/acceptance-criteria-generator`). Validators and reviewers are **not** skills.
...
| Worker allow-list | Optional: `acceptance-criteria-generator` |
