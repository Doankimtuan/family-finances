# Skill Binding — `refactoring-consultant`

Skill claim/execute binding for Solution Architecture worker `refactoring-consultant`.
Skills live under `skills/refactoring-consultant`. Validators/reviewers are not skills.
...
| Worker allow-list | Optional: `refactoring-consultant` |
