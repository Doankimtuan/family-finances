# Worker Conformance Checklist — `task-generator`
...
- [x] Directory name equals `task-generator`
...
- [x] Skill package reserved at `skills/task-generator/`
...
- [x] Primary output `engineering-task-graph`
