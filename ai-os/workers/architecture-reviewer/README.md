...
Review architecture quality, module boundaries, layering, patterns, coupling, cohesion, complexity, extensibility, scalability, and architecture decisions.

## Identity

| Field | Value |
|-------|-------|
| Worker id | `architecture-reviewer` |
