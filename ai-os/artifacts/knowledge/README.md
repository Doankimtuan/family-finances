# `artifacts/knowledge/` — Product reverse-engineering (consume)

Working folder for Product RE `knowledge-notes` mirrors and templates.
...
| Role | Worker |
|------|--------|
| Primary consume | `product-knowledge-ingest` |
