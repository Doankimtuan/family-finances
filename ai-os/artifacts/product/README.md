# `artifacts/product/` — Product reverse-engineering (produce)

Working folder for Product RE `product-model` mirrors and templates.
...
| Role | Worker |
|------|--------|
| Primary produce | `product-analyst` |
| Artifact type | `product-model` |
