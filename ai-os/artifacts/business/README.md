# `artifacts/business/` — Product reverse-engineering (consume)

Working folder for Product RE `business-rules` mirrors and templates.
...
| Role | Worker |
|------|--------|
| Primary consume | `business-rules-extractor` |
