...
Schema: `core/packages/schemas/validator-spec.schema.json`
...
Template: `core/packages/templates/validation/`
...
- Registry: `core/packages/registry/validators.json` `entries.<id>`
