...
**Scope:** `core/packages/pipelines/runtime-engine/`, `runtime/`, fifteen runtime workers, schemas, registries, command registry, default `.ai-os.yaml`
...
├── logs/
├── events/
├── core/packages/configs/           # .ai-os.yaml, run.yaml, workspace.yaml
├── checkpoint/
├── resume/
├── scheduler/
...
- Orchestrate-only: never mutate core/packages/workers/validators/reviewers
