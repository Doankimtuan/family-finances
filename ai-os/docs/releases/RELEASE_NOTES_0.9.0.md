...
**Scope:** `core/packages/pipelines/framework-generator/`, `core/packages/scaffold/`, ten generator workers, schemas, registries, catalog
...
- Configuration-driven generation via `core/packages/configs/sample-capability.yaml`
