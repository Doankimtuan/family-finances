---
name: discover-gap-report
description: Reserved discovery skill for worker discover-gap-report. Emits discovery-report artifacts only.
---
...
2. Inventory the scoped surface for this skill (see worker `discover-gap-report` README).
