...
`architecture-v2/`, `decision-records/`, `redesign/` → `architecture-v2-spec`

## Procedure

1. Load validated consume packs: knowledge/, features/, business/, product-architecture/ (architecture input), requirements/, quality/.
...
4. Write architecture-v2-spec; emit ADR entries into decision-records/; summarize under redesign/.
5. Stop for validation/review. Never overwrite discovery/Product RE artifacts.
