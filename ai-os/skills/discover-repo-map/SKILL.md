...
description: Reserved discovery skill for worker discover-repo-map. Emits discovery-report artifacts only.
---

# Discover Repository Map
...
2. Inventory the scoped surface for this skill (see worker `discover-repo-map` README).
