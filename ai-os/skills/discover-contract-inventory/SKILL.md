---
name: discover-contract-inventory
description: Reserved discovery skill for worker discover-contract-inventory. Emits discovery-report artifacts only.
---
...
2. Inventory the scoped surface for this skill (see worker `discover-contract-inventory` README).
