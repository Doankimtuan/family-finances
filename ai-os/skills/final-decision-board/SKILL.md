...
`artifacts/` (soft), `validation/`, `reports/`, `scores/`, `knowledge/` (soft), `specifications/` (soft), `pipelines/`, `reviews/`, `governance/` (soft)

## Produces

Partitioned `governance-decision` via `folder_mirror`: `decisions/`, `recommendations/`, `improvements/`, `governance/
...
See `pipelines/review-engine/RACI.md`.
