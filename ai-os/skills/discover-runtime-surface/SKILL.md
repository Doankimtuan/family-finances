---
name: discover-runtime-surface
description: Reserved discovery skill for worker discover-runtime-surface. Emits discovery-report artifacts only.
---
...
2. Inventory the scoped surface for this skill (see worker `discover-runtime-surface` README).
