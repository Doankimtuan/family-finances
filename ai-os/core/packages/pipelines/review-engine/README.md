...
|------|---------|----------|
| 0 | 9 `*-reviewer` | `governance/reviews/<worker_id>/` |
| 1 | `review-orchestrator` | `review-status` + `review-scores` |
| 2 | `final-decision-board` | partitioned `governance-decision` |

Smoke: `npm run aios:review-engine:smoke` · Contract: `core/packages/contracts/review-engine.md` · RACI: [RACI.md](./RACI.md)
