# Skill Binding — `implementation-planner`

Skill claim/execute binding for Specification Engineering worker `implementation-planner`.
Skills live under `skills/implementation-planner`. Validators/reviewers are not skills.
...
| Worker allow-list | Optional: `implementation-planner` |
