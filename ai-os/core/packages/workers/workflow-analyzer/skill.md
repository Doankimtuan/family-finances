# Skill Binding — `workflow-analyzer`

Skill claim/execute binding for Product RE worker `workflow-analyzer`.
Skills are declarative packages (`skills/workflow-analyzer`). Validators and reviewers are **not** skills.
...
| Worker allow-list | Optional: `workflow-analyzer` |
