# Worker Conformance Checklist — `workflow-analyzer`
...
- [x] Directory name equals `workflow-analyzer`
...
- [x] Skill package reserved at `skills/workflow-analyzer/`
...
- [x] Primary output `workflow-model`
