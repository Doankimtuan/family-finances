...
> **Discovery Worker package** `discover-domain-map` (class=`discovery`).  
...
Normalize business domain boundaries from DOMAIN_MAP and product docs into a discovery-report without proposing feature implementations.
