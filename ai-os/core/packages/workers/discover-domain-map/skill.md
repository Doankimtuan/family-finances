# Skill Binding — `discover-domain-map`

> Template for how this worker loads and executes AIOS **skills**.  
> Skills are declarative packages (`skills/discover-domain-map`). This worker is the runtime that claims runs and applies them.  
...
| Worker allow-list | Optional: `discover-domain-map` |
