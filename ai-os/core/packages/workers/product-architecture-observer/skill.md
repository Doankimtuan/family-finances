# Skill Binding — `product-architecture-observer`

Skill claim/execute binding for Product RE worker `product-architecture-observer`.
Skills are declarative packages (`skills/product-architecture-observer`). Validators and reviewers are **not** skills.
...
| Worker allow-list | Optional: `product-architecture-observer` |
