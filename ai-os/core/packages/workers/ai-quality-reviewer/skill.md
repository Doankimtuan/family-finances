...
`artifacts/` (soft), `artifacts/validation/`, `artifacts/reports/`, `artifacts/scores/`, `artifacts/knowledge/` (soft), `artifacts/specifications/` (soft), `core/packages/pipelines/`, `core/packages/workers/`, `skills/`, `core/packages/schemas/`, `core/packages/registry/`, `core/packages/templates/`

## Produces

`governance/reviews/ai-quality-reviewer/` → `review-finding` (`folder_mirror`: `governance/reviews/ai-quality-reviewer/…`)
...
4. Write under `governance/reviews/ai-quality-reviewer/` with `folder_mirror`.
...
- `folder_mirror` under `governance/reviews/ai-quality-reviewer/`
