...
Verify execution order, stage dependencies, pipeline/worker registration, lifecycle, resume and incremental support. Never modify artifacts.

## Identity

| Field | Value |
|-------|-------|
| Worker id | `pipeline-validator` |
