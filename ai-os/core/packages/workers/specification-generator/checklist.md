# Worker Conformance Checklist — `specification-generator`
...
- [x] Directory name equals `specification-generator`
...
- [x] Skill package reserved at `skills/specification-generator/`
...
- [x] Primary output `project-specification`
