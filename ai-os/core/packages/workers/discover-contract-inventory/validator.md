# Validator Binding — `discover-contract-inventory`
...
| Worker allow-list | Optional: `discovery-schema-check` |
...
| Run id | yes |
| Validator package (`core/packages/validators/discovery-schema-check`) | yes |
