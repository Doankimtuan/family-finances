# Examples — `discover-contract-inventory`
...
| `sample-discovery-report.json` | Primary `discovery-report` payload (validates `core/packages/schemas/discovery-report.schema.json`) |
