...
Verify every artifact traces to features, business rules, architecture, requirements, knowledge. Reject orphans. Never modify artifacts.

## Identity

| Field | Value |
|-------|-------|
| Worker id | `traceability-validator` |
