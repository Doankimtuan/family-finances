...
Review plugin support, customization, future features, module isolation, and reuse potential.

## Identity

| Field | Value |
|-------|-------|
| Worker id | `extensibility-reviewer` |
| Pipeline | `review-engine` |
| Depends on | — |
| Skill | `extensibility-reviewer` |
