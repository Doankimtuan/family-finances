...
`artifacts/validation/completeness-validator/` → `validation-finding` (required `folder_mirror`: `artifacts/validation/completeness-validator/…`)
...
3. Emit entries with full fields + `folder_mirror` under `artifacts/validation/completeness-validator/`.
...
- Every entry has full fields + `folder_mirror` matching `artifacts/validation/completeness-validator/`
