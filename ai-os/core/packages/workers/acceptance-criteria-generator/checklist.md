# Worker Conformance Checklist — `acceptance-criteria-generator`
...
- [x] Directory name equals `acceptance-criteria-generator`
...
- [x] Skill package reserved at `skills/acceptance-criteria-generator/`
...
- [x] Primary output `acceptance-criteria`
