# Validator Binding — `acceptance-criteria-generator`
...
| Worker allow-list | Optional: `product-re-schema-check` |
...
| Run id | yes |
| Validator package (`core/packages/validators/product-re-schema-check`) | yes |
