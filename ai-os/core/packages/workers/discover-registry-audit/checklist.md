# Worker Conformance Checklist — `discover-registry-audit`
...
- [x] Directory name equals `discover-registry-audit` (kebab-case)
...
- [x] Reserved discovery skill package exists at `skills/discover-registry-audit/`
...
- [x] Schema `$id` uses core/packages/workers/discover-registry-audit/output.schema.json pattern
