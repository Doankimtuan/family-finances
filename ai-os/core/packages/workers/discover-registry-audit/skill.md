# Skill Binding — `discover-registry-audit`

> Template for how this worker loads and executes AIOS **skills**.  
> Skills are declarative packages (`skills/discover-registry-audit`). This worker is the runtime that claims runs and applies them.  
...
| Worker allow-list | Optional: `discover-registry-audit` |
