...
> **Discovery Worker package** `discover-registry-audit` (class=`discovery`).  
...
| Field | Value |
|-------|-------|
| Worker id | `discover-registry-audit` |
| Version | `0.1.0` |
| Status | `draft` |
...
Compare registry entries (skills, validators, reviewers, workers, artifact-types) to on-disk packages and report gaps or reserved-only stubs.
