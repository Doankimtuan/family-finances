# Skill Binding — `task-generator`

Skill claim/execute binding for Specification Engineering worker `task-generator`.
Skills live under `skills/task-generator`. Validators/reviewers are not skills.
...
| Worker allow-list | Optional: `task-generator` |
