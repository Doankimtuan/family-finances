# Skill Binding — `business-rules-extractor`

Skill claim/execute binding for Product RE worker `business-rules-extractor`.
Skills are declarative packages (`skills/business-rules-extractor`). Validators and reviewers are **not** skills.
...
| Worker allow-list | Optional: `business-rules-extractor` |
