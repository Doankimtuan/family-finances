# Skill Binding — `feature-surface-inventory`

Skill claim/execute binding for Product RE worker `feature-surface-inventory`.
Skills are declarative packages (`skills/feature-surface-inventory`). Validators and reviewers are **not** skills.
...
| Worker allow-list | Optional: `feature-surface-inventory` |
