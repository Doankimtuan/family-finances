# Worker Conformance Checklist — `feature-surface-inventory`
...
- [x] Directory name equals `feature-surface-inventory`
...
- [x] Skill package reserved at `skills/feature-surface-inventory/`
...
- [x] Primary output `feature-inventory`
