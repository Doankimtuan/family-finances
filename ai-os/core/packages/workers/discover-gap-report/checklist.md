# Worker Conformance Checklist — `discover-gap-report`
...
- [x] Directory name equals `discover-gap-report` (kebab-case)
...
- [x] Reserved discovery skill package exists at `skills/discover-gap-report/`
...
- [x] Schema `$id` uses core/packages/workers/discover-gap-report/output.schema.json pattern
