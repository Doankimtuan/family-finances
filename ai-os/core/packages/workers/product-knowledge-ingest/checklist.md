# Worker Conformance Checklist — `product-knowledge-ingest`
...
- [x] Directory name equals `product-knowledge-ingest`
...
- [x] Skill package reserved at `skills/product-knowledge-ingest/`
...
- [x] Primary output `knowledge-notes`
