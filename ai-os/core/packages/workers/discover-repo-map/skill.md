# Skill Binding — `discover-repo-map`

> Template for how this worker loads and executes AIOS **skills**.  
> Skills are declarative packages (`skills/discover-repo-map`). This worker is the runtime that claims runs and applies them.  
...
| Worker allow-list | Optional: `discover-repo-map` |
