# Worker Conformance Checklist — `discover-repo-map`
...
- [x] Directory name equals `discover-repo-map` (kebab-case)
...
- [x] Reserved discovery skill package exists at `skills/discover-repo-map/`
...
- [x] Schema `$id` uses core/packages/workers/discover-repo-map/output.schema.json pattern
