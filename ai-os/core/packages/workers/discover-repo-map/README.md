...
> **Discovery Worker package** `discover-repo-map` (class=`discovery`).  
...
Inventory the repository layout (packages, entrypoints, app vs ai-os boundaries) and emit a discovery-report locating durable paths agents must respect.
