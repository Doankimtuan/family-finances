# Worker Conformance Checklist — `discover-runtime-surface`
...
- [x] Directory name equals `discover-runtime-surface` (kebab-case)
...
- [x] Reserved discovery skill package exists at `skills/discover-runtime-surface/`
...
- [x] Schema `$id` uses core/packages/workers/discover-runtime-surface/output.schema.json pattern
