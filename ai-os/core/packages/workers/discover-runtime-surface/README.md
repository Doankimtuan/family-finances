...
> **Discovery Worker package** `discover-runtime-surface` (class=`discovery`).  
...
| Field | Value |
|-------|-------|
| Worker id | `discover-runtime-surface` |
| Version | `0.1.0` |
| Status | `draft` |
...
Map Core Engine public APIs, orchestration lifecycle states, and runtime mounts so later work targets the control plane correctly.
