# Worker Conformance Checklist — `product-re-gap-report`
...
- [x] Directory name equals `product-re-gap-report`
...
- [x] Skill package reserved at `skills/product-re-gap-report/`
...
- [x] Primary output `product-re-gap`
