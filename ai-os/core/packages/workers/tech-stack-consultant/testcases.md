# Testcases index — `tech-stack-consultant`
...
- Consumes: `artifacts/knowledge/`, `artifacts/features/`, `artifacts/business/`, `artifacts/product-architecture/` (logical `docs/architecture/`), `artifacts/requirements/`, `governance/quality/`, `artifacts/architecture-v2/`
- Primary type: `tech-stack-recommendation`
