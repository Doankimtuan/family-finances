...
- [ ] Contains exactly the mandatory files from `core/packages/templates/worker/README.md`
- [ ] No undeclared executables that mutate the product repo
- [ ] `manifest.json` present (from template) and validates against `core/packages/schemas/worker-manifest.schema.json`
...
- [ ] Conforms to `core/packages/contracts/worker-port.md`
