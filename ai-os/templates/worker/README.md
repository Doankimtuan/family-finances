...
- **Discovery Workers** (`worker_class: discovery`) may be instantiated under `ai-os/workers/discover-*`, Product RE (`pipelines/product-re/`), or Solution Architecture (`pipelines/solution-architecture/`) in the current phase.
