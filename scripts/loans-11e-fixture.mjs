 ...
 *
 *   node scripts/loans-11e-fixture.mjs setup
 *   node scripts/loans-11e-fixture.mjs cleanup
 *
...
const FIXTURE = {
  ...
  termMonths: 24,
  currency: "VND",
  statePath: resolve(process.cwd(), "output/playwright/loans-11e-fixture.json"),
};
