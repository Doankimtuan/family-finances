 ...
 *
 *   node scripts/home-product-summary-fixture.mjs setup
 *   node scripts/home-product-summary-fixture.mjs cleanup
 */
...
const STATE_PATH = resolve(
  process.cwd(),
  "output/playwright/home-product-summary-fixture.json",
);
...
async function setup() {
  ...
  await run(process.execPath, ["scripts/loans-fixture.mjs", "setup"]);
  ...
  if (cycles.error) throw cycles.error;
  const debt = await admin.from("liabilities").insert({
    household_id: householdId,
...
if (process.argv[2] === "cleanup") {
  await cleanup(householdId);
  await run(process.execPath, ["scripts/loans-fixture.mjs", "cleanup"]);
